...
import { Loader2, Search, TrendingUp, DollarSign, Target, List, FolderKanban, Upload } from "lucide-react";
import { KeywordGrouping } from "./keyword-grouping";
    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="research" className="space-y-6">
        ...
        <TabsContent value="batch">
          <BatchImport projects={projects} onComplete={loadKeywords} />
        </TabsContent>
            ...
            <Card>
              <CardContent className="py-12">
                <div className="text-center text-muted-foreground">
                  ...
                  <p>Add keywords to see them grouped by intent, difficulty, or volume</p>
                </div>
              </CardContent>
            </Card>
          )}
